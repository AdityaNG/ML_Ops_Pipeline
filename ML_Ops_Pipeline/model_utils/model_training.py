...
from ..constants import DATASET_DIR, MODEL_TRAINING, ENSEMBLE_TRAINING, MODEL_TESTING
...
def main():
	...
	for (pipeline_name, model_name, interpreter_name, dataset_dir, model_classes, interpreters, task_id, model_last_modified, task_id_source_hash, model_last_source_hash, visualizers) in pool_args:
		status, task_id2, model_last_modified, task_id_source_hash2, model_last_source_hash = train_model(pipeline_name, model_name, interpreter_name, dataset_dir, model_classes, interpreters, task_id, model_last_modified, task_id_source_hash, model_last_source_hash, visualizers)
