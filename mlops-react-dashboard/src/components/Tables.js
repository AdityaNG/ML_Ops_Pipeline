...
export const DatasetsTable = (props) => {
	console.log(props)
	const totalDatasets = props.datasets.length;
  
	const TableRow = (props) => {
	  const { indexNumber, interpreter, size, issueDate, name } = props;
		  ...
		  <Table hover className="user-table align-items-center">
			<thead>
			  <tr>
				...
				<th className="border-bottom">interpreter</th>
				<th className="border-bottom">Size</th>
				<th className="border-bottom">Action</th>
			  </tr>
			</thead>
			<tbody>
			  {props.datasets.map(t => <TableRow key={`transaction-${t.invoiceNumber}`} {...t} />)}
			</tbody>
		  </Table>
  ...
  export const ModelsTable = (props) => {
	const totalDatasets = models.length;
  
	const TableRow = (props) => {
	  const { indexNumber, model, size, issueDate, name, score, status } = props;
	  const statusVariant = status === "Done" ? "success"
	  ...
	  <Card border="light" className="table-wrapper table-responsive shadow-sm">
		<Card.Body className="pt-0">
		  <Table hover className="user-table align-items-center">
			...
			<tbody>
			  {props.models.map(t => <TableRow key={`transaction-${t.indexNumber}`} {...t} />)}
			</tbody>
		  </Table>
		  <Card.Footer className="px-3 border-0 d-lg-flex align-items-center justify-content-between">
			<Nav>
...
export const EnsemblesTable = (props) => {
	const totalDatasets = props.ensembles.length;
	  ...
	  <Card border="light" className="table-wrapper table-responsive shadow-sm">
		<Card.Body className="pt-0">
		  <Table hover className="user-table align-items-center">
			...
			<tbody>
			  {props.ensembles.map(t => <TableRow key={`transaction-${t.indexNumber}`} {...t} />)}
			</tbody>
		  </Table>
		  <Card.Footer className="px-3 border-0 d-lg-flex align-items-center justify-content-between">
			<Nav>
