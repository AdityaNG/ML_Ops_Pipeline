...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faSignOutAlt, faTable, faTimes, faCalendarAlt, faMapPin, faInbox, faRocket, faDatabase, faBrain } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="ML Ops" link={Routes.Presentation.path} image={ReactHero} />

              <NavItem title="Overview" link={Routes.DashboardOverview.path} icon={faChartPie} />
			  <NavItem title="Datasets" icon={faDatabase} link={Routes.Datasets.path} />
			  <NavItem title="Models" icon={faBrain} link={Routes.Models.path} />
			  <NavItem title="Ensembles" icon={faRocket} link={Routes.Ensembles.path} />
			  <NavItem title="Config.py" icon={faCog} link={Routes.Settings.path} />
			{/* 
